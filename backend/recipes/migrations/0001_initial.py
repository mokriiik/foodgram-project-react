    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredientsRecipes', to='recipes.ingredient', verbose_name='Ингредиенты в рецепте')),
            ],
            options={
